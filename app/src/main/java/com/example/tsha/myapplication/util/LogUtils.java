package com.example.tsha.myapplication.util;
...
import com.example.tsha.myapplication.BuildConfig;
...
public class LogUtils {
    ...
    static final String ROOT_LOG_FILE_NAME = "kt-innocar-log.txt";
...
//        final Logger obd = com.pokevian.lib.obd2.util.Log.logger;
...
//            obd.setLevel(Level.ALL);
        } else {
            root.setLevel(Level.DEBUG);
//            obd.setLevel(Level.DEBUG);
        }
    }
